...
import com.elderbyte.security.rsa.RSAKeyLoadingException;
...
public class JWSVerifierService {
     ...
     */
    public JWSVerifierService(ElderSecurityJwtSettings clientSettings, RSAPublicKeyProvider rsaPublicKeyProvider){
